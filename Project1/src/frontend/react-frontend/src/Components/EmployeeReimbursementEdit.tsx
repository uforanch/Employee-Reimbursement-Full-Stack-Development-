...
function EmployeeReimbursementEdit() {
    ...
    return <>
    <div className="Edit">
        <p>date issued: </p> <p className="Disp">{getR.date_issued.toString()}</p><p> value:</p><p className="Disp"> {getR.value} </p><p>user: </p><p className="Disp"> {getR.username} </p><p> status: </p><p className="Disp"> {getR.status} </p>
...
export default EmployeeReimbursementEdit
